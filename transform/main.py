...
def _remove_new_lines_from_body(df):
    ...
    # Más facil: df['body'].str.replace('\n', '')
    df['body'] = stripped_body
    return df


def _tokenize_column(df, column_name, language):
    logger.info(f'Tokenizing column {column_name} in {language} language')
...
def _remove_duplicate_entries(df, column_name):
    logger.info(f'Removing duplicate entries from column {column_name}')
